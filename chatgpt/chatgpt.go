			...
			Messages: []openai.ChatCompletionMessage{
				{
					...
					Content: "You are an assistant that trys to evaluate if and when a twitch livestreamer will stream again based on a text that had been said during a past livestream. If you are unsure about the time, default to 17:00. If he doesn't say something if he is planning to stream or not, default to an empty array.",
				},
				{
